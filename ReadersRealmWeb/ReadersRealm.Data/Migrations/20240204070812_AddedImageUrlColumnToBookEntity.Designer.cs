...
namespace ReadersRealm.Data.Migrations
{
    ...
    [Migration("20240204070812_AddedImageUrlColumnToBookEntity")]
    partial class AddedImageUrlColumnToBookEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReadersRealm.Data.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cb174bf8-7a62-4b5b-bdcd-429e808ef3b0"),
                        ...
                        new
                        {
                            Id = new Guid("b055d843-e823-4405-9420-cbf82826a0dd"),
